...
void findCheapestMoment(map<string,double> m);
void findBestPeriodToBuyAndSale(map<string,double> m);
...
int main()
{
    map<string,double> mapYearPrice;
    map<string,double> mapYearInflaction;
    ...
    do{
        ...
        {
        case 1:
            mapYearPrice=readCSVFile("../terre_rare/cours_terres_rares.csv");
            mapYearInflaction=readCSVFile("../terre_rare/inflation.csv");
            displayMap(mapYearPrice);
            findCheapestMoment(mapYearPrice);
            findBestPeriodToBuyAndSale(mapYearInflaction);
        ...
        case 2:
            mapYearPrice=readCSVFile("../or/cours_or.csv");
            mapYearInflaction=readCSVFile("../or/inflation.csv");
            displayMap(mapYearPrice);
            findCheapestMoment(mapYearPrice);
            findBestPeriodToBuyAndSale(mapYearInflaction);
